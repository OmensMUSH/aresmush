  ...
  module Profile
    class CustomCharFields
      ...
      def self.get_fields_for_viewing(char, viewer)
        return { personality: Website.format_markdown_for_html(char.personality) }
      end
      ...
      def self.get_fields_for_editing(char, viewer)
        return { personality: Website.format_input_for_html(char.personality) }
      end
      ...
      def self.save_fields_from_profile_edit(char, char_data)
        char.update(personality: Website.format_input_for_mush(char_data[:custom][:personality]))
      end
